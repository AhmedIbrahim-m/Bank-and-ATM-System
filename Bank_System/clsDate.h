...
public:
  ...
  static string PrintDateNow() { return DateToString(GetSystemDate()); }
  ...
  clsDate IncreaseDateByOneMonth(clsDate &Date) {
    ...
    // last check day in date should not exceed max days in the current _Month
    //  example if date is 31/1/2022 increasing one _Month should not be
